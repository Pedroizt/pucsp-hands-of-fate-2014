...
//	DebugDrawStuff();
	...
	var currentAngle = camera2.eulerAngles.y;
	...
	transform.localEulerAngles = new Vector3(transform.localEulerAngles.x, camera2.transform.localEulerAngles.y, transform.localEulerAngles.z); 
